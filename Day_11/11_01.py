...
same floor in this way, as they can be connected while the elevator 
is recharging.)
...
PERSONAL NOTES:
* You cannot move the elevator when it is empty.
* Microchips cannot be left next to incompatible generators
* To keep the number of moves to a minimum always strive to have 2 objects
  on the elevator...at least on upward trips.
"""
