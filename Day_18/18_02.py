...
respectively. Then, a new tile is a trap only in one of the 
...
def find_safe_tile_count( num_rows ):
	...
	row = ['^.'.find( c ) for c in data ]
	safe_tile_count = sum( row )
...
if __name__ == '__main__':
	safe_tile_count = find_safe_tile_count( 400000 )
	print( f'The number of safe tiles is {safe_tile_count}.')
