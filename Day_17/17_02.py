...
character (any number or a) means that the corresponding door is closed 
and locked.
...
and so your path is empty: you simply find the MD5 hash of hijkl alone. 
...
#	shortest_path = get_shortest_path( 'hhhxzeay' )
