...
that data. Calculate the checksum only for the data that fits on the disk, even 
...
PERSONAL NOTES:
* Put a 0 at the end of 'b', not just betweeen 'a' and 'b'
"""								  
...
if __name__ == '__main__':
	checksum = fill_disk( 10001001100000001, 272 )
